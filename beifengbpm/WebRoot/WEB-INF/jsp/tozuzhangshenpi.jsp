...
<html>
  ...
  <body>
<form action="zuzhangshenpi.do" method="post">
    	...
    	<tr>
    		<td>
    			<table width="80%" align="center" border="1">
    				...
    				<tr>
    					<td colspan="4">
    						<textarea name="approvation"></textarea>
    					</td>
    				</tr>
    				<tr>
    					<td colspan="2"><input type="submit" name="option" value="同意"></td>
    					<td colspan="2"><input type="submit" name="option" value="不同意"></td>
    				</tr>
    			</table>
    		</td>
    	</tr>
